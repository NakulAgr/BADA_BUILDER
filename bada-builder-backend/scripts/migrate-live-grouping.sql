...
-- MIGRATION: Add multi-property support for Mixed Use Complex
-- Purpose: Store multiple property types and their configurations in one project record.

ALTER TABLE live_group_projects 
ADD COLUMN IF NOT EXISTS property_types TEXT[],
ADD COLUMN IF NOT EXISTS property_configs JSONB;

-- ROLLBACK: 
-- ALTER TABLE live_group_projects DROP COLUMN IF EXISTS property_types;
-- ALTER TABLE live_group_projects DROP COLUMN IF EXISTS property_configs;
